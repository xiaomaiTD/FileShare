...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    EasyAlertView *alert = [[EasyAlertView alloc] initWithType:AlertViewSheet andTitle:model.name andActionArray:actionArray andActionBlock:^(NSString *title,NSInteger index,NSArray *textFieldArray) {
