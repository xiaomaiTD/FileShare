...
#import "SendMessageManger.h"

#define  SENDING_TAG        10000
@interface SendMessageManger () <AsyncSocketDelegate>

@end

@implementation SendMessageManger
{
...
- (void)waitSendFileWithName:(NSString*)name fileLength:(NSUInteger)total{
    ...
    {
        NSString *msg=[NSString stringWithFormat:@"{\"fileName\":\"%@\",\"fileLength\":%u}",name,total];
        [asyncSocket writeData:[msg dataUsingEncoding:NSUTF8StringEncoding] withTimeout:-1 tag:kFileSendWaitTag];
    }
