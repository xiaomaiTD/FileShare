...
@property (nonatomic, strong) FolderCell *templateCell;
...
- (CGSize)calculateItemSizeWithIndex:(NSInteger)index{
    ...
    FolderCell *tempCell = [self templateCellWithReuseIdentifier:self.reuseIdentifier withIndex:index];
    tempCell.model = self.datas[index];
